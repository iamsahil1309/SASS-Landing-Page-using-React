...
function PlanCard({price, title, description, features, isPopular}) {
  return (
    <div className='border flex flex-col justify-between bg-white/20 backdrop-blur-lg rounded-lg h-full p-6 hover:shadow-md text-left relative'>
      ...
      <div>
        <button className='bg-indigo-500 py-2 mt-3 rounded-lg hover:bg-indigo-600 text-white w-full'>Select Plan</button>
      </div>
    </div>
